...
# ---------------------------------- Task 3 ---------------------------------- #
""" DESCRIPTION:
    Develop a simple temperature converter program that converts temperatures from Fahrenheit to Celsius and vice versa based on user choice. 
    Make a user-friendly interface as given in EXPECTED OUTPUT:.
...
x: str = '1 => Convert to Fahrenheit '
y: str = '2 => Convert to Celsius '
z: str = ' Fahrenheit/Celsius Converter '
print(f'{z:*^53}')
print(f'# {x:<50}#')
print(f'# {y:<50}#')
print("*" * 53)
...
if x == 1:
    ...
    temp_fahrenheit =(x*9/5)+32
    print(f"{x}°C is {temp_fahrenheit}°F")
elif x == 2:
   x = float(input("Enter temperature in Fahrenheit: ")) 
   temp_celsium = (x-32)*(5/9)  
   print(f"{x}°F is {temp_celsium}°C ")
